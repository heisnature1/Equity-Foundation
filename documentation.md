...
- Overhauled and completed all 5 dedicated civic portal pages to fit the viewport (`min-height: calc(100svh - 84px)`) on desktop screens:
  1. **Legal Help Portal (`/legal-help` / `components/legal-help-portal.tsx`):** Viewport-fitting 2-column layout with 3D `DottedSurface` ground plane, emergency hotlines card (Police 191/112, DOVVSU 0800 111 222), 3 intake benchmarks, and an elevated SSL-encrypted pro bono triage form with interactive client-side submission, validation, and confirmation states.
